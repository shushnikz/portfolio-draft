...
export default function Project(){
  ...
  <div className="col">
    <div className="card h-100">
      <img src="https://techcrunch.com/wp-content/uploads/2014/05/petmatch-adopts.png?w=730&crop=1" 
      className="card-img-top" alt="cat-app"></img>
      <div className="card-body">
        <h5 className="card-title head">Know About Cats</h5>
        <p className="card-text cont">Technologies used: HTML CSS Javascript</p>
        <p className="card-text cont">In this app you can know about the cat across the world 
        and get full descripton about it</p>
      </div>
      <div className="card-footer">
      <div className="d-flex justify-content-between">
        <a href="https://reliable-wisp-3a127f.netlify.app/" target="_blank"
        className="text-muted"><IconButton>
            <FileCopyIcon style={{color: "grey"}}/>
            </IconButton></a>
            <a href="https://github.com/shushnikz/public-api-cat" target="_blank"
            className="text-muted"><IconButton>
            <GitHubIcon style={{color: "grey"}}/>
            </IconButton></a>
      </div>
